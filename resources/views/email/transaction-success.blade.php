                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;">
                                                            <img alt="" height="auto" src="{{url('assets/gallery/'.$data->travel_package->image)}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
